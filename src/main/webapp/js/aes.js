...
//# sourceMappingURL=md5.js
var aes = {
    key: CryptoJS.enc.Utf8.parse("$amox^buzz&ukcn*"), encrypt: function (word) {
        var srcs = CryptoJS.enc.Utf8.parse(word);
        var encrypted = CryptoJS.AES.encrypt(srcs, aes.key, {mode: CryptoJS.mode.ECB, padding: CryptoJS.pad.Pkcs7});
        return encrypted.toString();
    }, decrypt: function (word) {
        var decrypt = CryptoJS.AES.decrypt(word, aes.key, {mode: CryptoJS.mode.ECB, padding: CryptoJS.pad.Pkcs7});
