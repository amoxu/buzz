...
public class JedisUtil {
     ...
     * @return
     */
    public static <T> T deSeri(byte[] data, Class<T> clazz) {
    ...
    public static void main(String[] args) {
        ...
        BuzzNetease buzzNetease = new BuzzNetease();

        buzzNetease.setId(1000);
        buzzNetease.setKeyword("haaaaaaaaaa");
        jedis.set("demo".getBytes(), enSeri(buzzNetease));
        byte[] demo = jedis.get("demo".getBytes());
        BuzzNetease buzzNetease1 = deSeri(demo, BuzzNetease.class);

        System.out.println(JSON.toJSONString(buzzNetease1));
        jedis.close();
